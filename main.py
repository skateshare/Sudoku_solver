...
# Greeting label
greeting_label = tk.Label(text="Welcome to October's Sudoku finder", bg="SkyBlue1",fg="blue")
greeting_label.grid(row = 0,column = 0,padx = 10, columnspan=8)


# reset button
reset_button = tk.Button(text='reset', fg='black', command=mySudoku.reset)
reset_button.grid(row=10, column=10, padx=5, pady=5)
